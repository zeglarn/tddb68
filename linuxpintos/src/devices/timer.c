...
/* LAB 2 */
bool less_ticks(struct list_elem *elem, struct list_elem *e, void *aux);
...
bool less_ticks(struct list_elem *elem, struct list_elem *e, void *aux)
{
  struct thread *t1 = list_entry(elem, struct thread, sleep_elem);
  struct thread *t2 = list_entry(e, struct thread, sleep_elem);
...
timer_sleep (int64_t ticks)
{
  ...
  list_insert_ordered(&sleep_list, &t->sleep_elem, &less_ticks, NULL);
